# DsA_PatternWISEE
after a long time finally i have dared to touch the github again and it was too for the most fearing subject DSAAAA !!  but dont worry this github repo will help you a lot to learn the dsa Pattern wise not just only the ARray Questions and im still learning too !! hehehe . Happy Learning : 


Yeah also after sometime i decided to add SQL portion also : 
all the txt files are the Questions from the GFG:
...
| [1068-product-sales-analysis-i](https://github.com/MeetKumar6789/DsA_PatternWISEE/tree/master/1068-product-sales-analysis-i) |
